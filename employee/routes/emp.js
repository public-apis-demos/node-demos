...
// singe employee
router.get("/employees/:id", verifyToken, singeEmployee, (req, res) => {
...
router.put("/update/:id", verifyToken, singeEmployee, async (req, res) => {
  //res.send("update");
...
// delete the employee
router.delete("/delete/:id", verifyToken, singeEmployee, async (req, res) => {
  //res.send("delete");
  console.log(req, ree);
  try {
